process BUSCO {
    ...
    conda (params.enable_conda ? "bioconda::busco=5.4.5" : null)
    container "${ workflow.containerEngine == 'singularity' && !task.ext.singularity_pull_docker_container ?
        'https://depot.galaxyproject.org/singularity/busco:5.4.5--pyhdfd78af_0':
        'quay.io/biocontainers/busco:5.4.5--pyhdfd78af_0' }"
