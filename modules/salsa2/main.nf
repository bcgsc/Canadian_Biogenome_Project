...
//    container ='docker://quay.io/biocontainers/salsa2:2.3--py27hee3b9ab_0'
    ...
    tuple val(meta), path("*/alignment_iteration_1.bed"), emit: alignment_iteration_1_bed, optional: true
    tuple val(meta), path("*/scaffold_length_iteration_1"), emit: scaffold_length_iteration_1, optional: true
