...
ch_multiqc_config          = Channel.fromPath("${params.hicpro_bin_path}/../assets/multiqc_config.yml", checkIfExists: true)
ch_multiqc_custom_config   = params.multiqc_config ? Channel.fromPath( params.multiqc_config, checkIfExists: true ) : Channel.empty()
ch_multiqc_logo            = params.multiqc_logo   ? Channel.fromPath( params.multiqc_logo, checkIfExists: true ) : Channel.empty()
ch_multiqc_custom_methods_description = params.multiqc_methods_description ? file(params.multiqc_methods_description, checkIfExists: true) : file("${params.hicpro_bin_path}/../assets/methods_description_template.yml", checkIfExists: true)
...
//SC : removed from multiQC summary 
